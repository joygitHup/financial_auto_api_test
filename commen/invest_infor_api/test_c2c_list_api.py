# -*- coding: utf-8 -*-
"""
@Time ： 2022/5/18 18:38
@Auth ： 你赖大爷
@File ：test_c2c_list_api.py
@IDE ：PyCharm
...
class test_c2c_list_api(unittest.TestCase):
    """c2c产品列表"""
    @classmethod
    def setUpClass(self):
        self.url = data_config.host+data_config.c2c_list_url
        self.header = data_config.header
    '''case01:正确添加账号'''
    def test_c2c_list_api_01(self):
